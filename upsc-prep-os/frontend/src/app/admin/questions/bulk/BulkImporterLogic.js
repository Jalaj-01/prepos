...
export default function BulkImporterLogic() {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            // Lazy import ONLY on client side
    ...
    const handleParse = () => {
        ...
        setParsedQuestions(
            parsed.filter(q => q.questionText.length > 10)
        );
    };
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <header className="mb-10">
                    ...
                    <p className="text-brand-muted font-medium mt-1 tracking-tight">
                        Paste text from UPSC PDFs to auto-generate question cards.
                    </p>
                                ...
                                parsedQuestions.length === 0 ? (
                                    ...
                                    parsedQuestions.map((q, idx) => (
                                        ...
                                        >
                                            ...
                                            <h3 className="font-bold text-brand-dark text-sm leading-relaxed mb-4">
                                                {q.questionText}
                                            </h3>
                                            ...
                                            <div className="grid grid-cols-2 gap-2">

                                                {
                                                    q.options.map(o => (
                                                        ...
                                                        <div
                                                            key={o.label}
                                                            className="text-[10px] font-bold bg-brand-light p-2 rounded-xl border border-brand-border truncate"
                                                        >
