...
export default function DailyPrepSetup() {
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <header className="mb-10">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-xs uppercase tracking-[0.3em] font-black text-brand-muted">

                            Continuous Preparation Engine
                    ...
                    <h1 className="text-5xl font-black text-brand-dark tracking-tighter">
                        ...
                        Set Up Daily Preparation

                    </h1>

                    <p className="text-brand-muted font-medium mt-2">

                        Create a persistent preparation track with non-repeating PYQs and weekly revision sessions.
                ...
                <div className="bg-white p-8 rounded-[32px] border border-brand-border shadow-premium mb-8">
                                ...
                                item => (
                                    ...
                                    <button
                                        ...
                                        className={`
                                            ...
                                            py-5 rounded-2xl border-2 font-black text-lg transition-all
                                    ...
                                    val => (
                                        ...
                                        <button
                                            ...
                                            className={`
                                                ...
                                                flex-1 py-4 rounded-xl font-black border-2 transition-all
                ...
                <button
                    ...
                    className="w-full mt-10 bg-brand-dark text-white p-6 rounded-[24px] font-black text-xl shadow-xl hover:bg-brand-accent transition-all flex items-center justify-center gap-4 cursor-pointer disabled:opacity-50"
                >
